export default {
  ...
  Earnings:{
    title: '收益说明',
    description1: '质押地址',
    description2: 'RUFF锁仓挖矿以100万RUFF为单位，锁仓份额以100万Ruff为一个单元，对应5000Usdt的挖矿份额，挖对标为Pickle的P3CRV池子，目前年化收益大致为31.5%(具体实际收益会有小浮动)',
    description3: '总挖矿量达到5000万RUFF后，才会在指定日期开启挖矿',
