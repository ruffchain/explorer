...
;(function(ErrorCode) {
  ...
  ErrorCode[(ErrorCode['RESULT_INVALID_SESSION'] = 21)] =
    'RESULT_INVALID_SESSION'
  ErrorCode[(ErrorCode['RESULT_OUT_OF_LIMIT'] = 22)] = 'RESULT_OUT_OF_LIMIT'
  ErrorCode[(ErrorCode['RESULT_PERMISSION_DENIED'] = 23)] =
  ...
  ErrorCode[(ErrorCode['RESULT_ERROR_NONCE_IN_TX'] = 27)] =
    'RESULT_ERROR_NONCE_IN_TX'
  ...
  ErrorCode[(ErrorCode['RESULT_VER_NOT_SUPPORT'] = 35)] =
    'RESULT_VER_NOT_SUPPORT'
  ErrorCode[(ErrorCode['RESULT_EXECUTE_ERROR'] = 36)] = 'RESULT_EXECUTE_ERROR'
  ErrorCode[(ErrorCode['RESULT_VERIFY_NOT_MATCH'] = 37)] =
    'RESULT_VERIFY_NOT_MATCH'
  ErrorCode[(ErrorCode['RESULT_TX_CHECKER_ERROR'] = 38)] =
    'RESULT_TX_CHECKER_ERROR'
  ErrorCode[(ErrorCode['RESULT_TX_FEE_NOT_ENOUGH'] = 39)] =
    'RESULT_TX_FEE_NOT_ENOUGH'
  ErrorCode[(ErrorCode['RESULT_SKIPPED'] = 40)] = 'RESULT_SKIPPED'
  ErrorCode[(ErrorCode['RESULT_TX_ADD_TOO_FREQUENTLY'] = 41)] =
    'RESULT_TX_ADD_TOO_FREQUENTLY'
...
export function stringifyErrorCode(err) {
